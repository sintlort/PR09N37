                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('add.product')}}" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="product_price" name="product_price" type="number" class="form-control" placeholder="Product price" aria-label="product_price" aria-describedby="basic-addon1">
                            </div>
